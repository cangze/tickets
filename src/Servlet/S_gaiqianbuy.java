...
/**
 * Servlet implementation class S_gaiqianbuy
 */
@WebServlet("/S_gaiqianbuy")
public class S_gaiqianbuy extends HttpServlet {
...
//		sub_start_arrive
		...
		int start_station_id=Integer.parseInt(request.getParameter("start_station_id"));
		int arrive_station_id=Integer.parseInt(request.getParameter("arrive_station_id"));
